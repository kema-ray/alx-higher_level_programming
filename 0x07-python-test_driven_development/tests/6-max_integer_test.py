...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_negative(self):
        """Checks if function can give the highest negative integer"""
        self.assertEqual(max_integer([-2, -4, -1, -5]), -1)

    def test_positive(self):
        """Checks if function can give the highest positiveinteger"""
        self.assertEqual(max_integer([2, 4, 1, 5]), 5)

    def test_positive_float(self):
        """Checks if function can give the highest positivefloat"""
        self.assertEqual(max_integer([2.75, 4.25, 1.25, 5.5]), 5.5)

    def test_neg_float(self):
        """Checks if function can give the highest negativefloat"""
    ...
    def test_max_integer(self):
        """Test the max_integer in the max_integer module"""
        self.assertEqual(max_integer([1, 4, 5, 3]), 5)
        self.assertEqual(max_integer([1]), 1)

    def test_if_negative_int_in_list(self):
        """Test the negative interger in list function"""
